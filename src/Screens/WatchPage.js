...
function WatchPage() {
  ...
  return (
    <Layout>
        <div className='container mx-auto bg-dry px-2 mb-12'>
            <div className='flex-btn flex-wrap mb-6 gap-2 bg-main rounded border border-gray-800 p-6'>
                ...
                <div className='flex-btn sm:w-auto gap-5'>
            ...
            {/* Watch page */}
            {
              ...
              <div className='w-full h-screen rounded-lg overflow-hidden relative'>
                <div className='absolute top-4 left-0 bottom-0 right-0 bg-main bg-opacity-3 0 flex-colo'>
              ...
              <img src={movie?.image ? `/images/movies/${movie.name}`
                : 'images/user.png'
