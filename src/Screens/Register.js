    ...
    <Layout>
        <div className='container mx-auto px-2 my-24 flex-colo'>
            <div className='w-full 2xl:w-2/5 gap-8 flex-colo sm:p-14 p-8 md:w-3/5 bg-dry rounded-lg border border-border'>
                ...
                <Input label="FullName" placeholder='Netflix React Tailwind' type='email' bg={true} />
                <Input label="Password" placeholder='********' type='password' bg={true} />

                <Link to='/dashboard' className='bg-subMain transition hover:bg-main flex-rows gap-4 text-white rounded-lg w-full'>
                    <FiLogIn />
                </Link>
