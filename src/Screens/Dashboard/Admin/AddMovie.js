        ...
        <div className='w-full grid md:grid-cols-2 gap-6'>   
            ...
            <div className='flex flex-col gap-2'>   
                ...
                <div className='w-32 h-32 p-2  bg-main border border-border rounded '>
                    <img src='/images/movies/11.jpeg ' alt='' className='w-full h-full object-cover rounded'/>
                </div>
            </div>    
            {/* image with title */}
            <div className='flex flex-col gap-2'>   
                ...
                <Uploder />
                <div className='w-32 h-32 p-2  bg-main border border-border rounded '>
                    <img src='/images/movies/10.jpeg ' alt='' className='w-full h-full object-cover rounded'/>
                </div>
             </div>
        </div>     
        {/* DESCRIPTION */}
