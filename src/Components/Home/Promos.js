    ...
    <div className='my-20 py-10 md:px-20 px-8 bg-dry'>
      <div className='lg:grid lg:grid-cols-2 lg:gap-10 items-center'>
        <div className='flex lg:gap-10 gap-6 flex-col'>
          <h1 className='xl:text-3l text-xl capitalize font-sans font-medium xl:leading-relaxed'>
            Download Your Movies Watch Offline <br />Enjoy n Your Mobile
          </h1>
          <p className='text-text text-sm xl:text-base leading-6 xl:leading-8'>
            Lorem ipsum dolar sit amet, consectetur adipiscing elit. Nunc sed
            Lorem ipsum dolar sit amet, consectetur adipiscing elit. Nunc sed
            Lorem ipsum dolar sit amet, consectetur adipiscing elit. Nunc sed
            Lorem ipsum dolar sit amet, consectetur adipiscing elit. Nunc sed
            Lorem ipsum dolar sit amet, consectetur adipiscing elit. Nunc sed
